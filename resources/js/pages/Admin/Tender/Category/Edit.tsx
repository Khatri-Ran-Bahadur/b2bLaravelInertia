...
export default function Update({ tenderCategory }: { tenderCategory: TenderCategory }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('admin.tender-categories.update', tenderCategory.id));
    };
                    ...
                    <CardHeader className="">
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{t('Update Tender Category')}</h1>
                                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-300">
                                        {t('Edit the details for category')}{' '}
                                        <span className="text-primary dark:text-primary-light font-medium">{tenderCategory.name}</span>
                                    </p>
                                </div>
                            </div>
