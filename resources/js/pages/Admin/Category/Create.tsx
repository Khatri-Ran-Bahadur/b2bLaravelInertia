...
export default function Create({ categories }: { categories: CategoryWithPath[] }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const normalizedParentId = data.parent_id === null || data.parent_id === 'none' ? null : Number(data.parent_id);
                    ...
                    <CardHeader>
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{t('Create Category')}</h1>
                                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-300">{t('Add a new category to your catalog')}</p>
                                </div>
                            </div>
                    ...
                    <CardContent className="p-0">
                        <form onSubmit={handleSubmit} className="p-6">
                            <div className="mx-auto max-w-xl space-y-6">
                                ...
                                {/* Enhanced Select for N-Level Parent Category */}
                                <div className="space-y-2">
                                    <Label
                                        htmlFor="parent_id"
                                        className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-200"
